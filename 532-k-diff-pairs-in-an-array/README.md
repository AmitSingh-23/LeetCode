...
🟡 **Medium** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/k-diff-pairs-in-an-array/)
...
**My Solution:** [532-K-diff-Pairs-in-an-Array.cpp](./532-K-diff-Pairs-in-an-Array.cpp)
