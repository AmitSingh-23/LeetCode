...
🟡 **Medium** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/smallest-string-starting-from-leaf/)
...
**My Solution:** [988-Smallest-String-Starting-From-Leaf.cpp](./988-Smallest-String-Starting-From-Leaf.cpp)
