...
🟡 **Medium** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/find-three-consecutive-integers-that-sum-to-a-given-number/)
...
**My Solution:** [2177-Find-Three-Consecutive-Integers-That-Sum-to-a-Given-Number.cpp](./2177-Find-Three-Consecutive-Integers-That-Sum-to-a-Given-Number.cpp)
