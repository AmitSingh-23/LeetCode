...
🟡 **Medium** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/minimum-remove-to-make-valid-parentheses/)
...
**My Solution:** [1249-Minimum-Remove-to-Make-Valid-Parentheses.cpp](./1249-Minimum-Remove-to-Make-Valid-Parentheses.cpp)
