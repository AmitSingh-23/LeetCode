...
🟡 **Medium** &nbsp;|&nbsp; [View on LeetCode](https://leetcode.com/problems/minimum-total-cost-to-process-all-elements/)
...
**My Solution:** [3987-Minimum-Total-Cost-to-Process-All-Elements.cpp](./3987-Minimum-Total-Cost-to-Process-All-Elements.cpp)
